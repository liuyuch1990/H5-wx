...
line-height: 0.4rem;">联系商家</a>
        ...
        <div class="panel" v-show="active == 'order'">
            ...
            <div>
                <div class="head-cell"
                     style="background: rgb(236, 236, 236);border-radius: 0.1rem;border: 1px solid #ccc;height:1rem;">
                ...
                <div v-for="item in orderList" :key="item.order_id" class="head-cell"
                     style="background: rgb(236, 236, 236);border-radius: 0.1rem;border: 1px solid #ccc;height:1rem;border-top:0;">
                    <div style="color:#ef5a5a;">
        ...
        <div class="panel" v-show="active == 'package'">
            ...
            <div>
                ...
                <div v-for="item in packageList" :key="item.order_id" class="head-cell"
                     style="background: rgb(236, 236, 236);border-radius: 0.1rem;border: 1px solid #ccc;height:1rem;border-top:0;">
                    -->
                    <div style="color:#ef5a5a;">
                        <span><img :src="item.headimgurl" style="width: 0.7rem;height: 0.7rem;"/></span>
        ...
        <div class="footer2">
            <div class="btn-c" v-show="home" @click="show" style="width: 50%;"
                 :style="{'background': active == 'pay' ? '#fdd926' : ''}">
                <i class="fa fa-shopping-cart" aria-hidden="true"></i> 我要抢购
            </div>
            <div class="btn-c" v-show="home" @click="getorder" style="width: 50%;"
                 :style="{'background': active == 'order' ? '#fdd926' : ''}">
            ...
            <div class="btn-c" v-show="!home" @click="getorder"
                 :style="{'background': active == 'order' ? '#fdd926' : ''}">
                <i class="fa fa-list-alt" aria-hidden="true"></i> 我的订单
            </div>
            <div class="btn-c" v-show="!home" @click="package2"
                 :style="{'background': active == 'package' ? '#fdd926' : ''}">
