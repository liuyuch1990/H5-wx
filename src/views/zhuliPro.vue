<template>
  <div class="wrap" ref="bgimage">
    ...
    <img v-else src="@/assets/img/zhuli.jpg" width="100%" />
    ...
    <content-wrap>
        ...
        <div v-if="!!this.shareId" @click="addZan" class="btn animate">帮忙助力</div>
        <div class="wrap-3">
        ...
        <span style="font-size: 0.3rem;color: #ccc;">已经有{{tlist.length}}个人帮你助力</span>
...
export default {
  ...
  methods: {
          ...
          wx.ready(() => {
            ...
            var shareParam = {
              ...
              link: location.origin + 
                ...
                "&shareId=" +
                self.shareId +
                "&hash=zhuliPro", // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
    ...
    goback() {
      this.$router.push({ path: "zhuliDev", query: { userVuex: true , isAdmin: this.$route.query.isAdmin} });
    },
    //被分享者参加活动
    linkreload() {
      location.href =
