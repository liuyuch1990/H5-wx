    ...
    export default {
        ...
        methods: {
            ...
            click(item) {
                ...
                if(item.label === '收费方式'){
                    window.location.href ='https://mp.weixin.qq.com/s/xHSFwvtK9V1uDRgrqcao2w';
                }
                if(item.label === '平台介绍'){
                    window.location.href ='https://mp.weixin.qq.com/s/Qwz6L8j4YYKhurE15QlmzQ';
                }
                if(item.label === '营销课程'){
                    window.location.href ='https://mp.weixin.qq.com/s/8bjgvtY65rnnuvE_guyZvQ';
                }
            }
        }
    };
